...
// =========================
// ARCHIVUM — Mandamientos (meta + poder)
// Nota: El poder NO desbloquea Pista 2. La Pista 2 se desbloquea con el “símbolo” del turno.
// =========================
const COMMANDMENT_META = {
  "No robarás": {
    image: "no-robaras.png",
    tag: "Bendición cooperativa",
    short: "Compartir ideas vale más que apropiárselas.",
    description: "Bendición: +1 intento (este acertijo). Voto: no pidas Pista 2 antes del primer fallo. Milagro: +1 intento ahora.",
    vow: { title: "Voto", text: "No puedes pedir Pista 2 antes del primer fallo del acertijo." },
    power: { title: "Milagro", text: "Recuperas +1 intento en este acertijo.", uses: { per: "turn", count: 1 }, effect: { addAttempts: 1 } }
  },
  "Honrarás a tu padre y a tu madre": {
    image: "honrar-padres.png",
    tag: "Disciplina y consejo",
    short: "Aceptar guía te fortalece.",
    description: "Bendición: +1 intento (este acertijo). Voto: antes de responder debe hablar 1 compañero. Milagro: +1 intento ahora.",
    vow: { title: "Voto", text: "Antes de dar una respuesta final, debe hablar al menos 1 compañero (aunque sea 1 frase)." },
    power: { title: "Milagro", text: "Recuperas +1 intento en este acertijo.", uses: { per: "turn", count: 1 }, effect: { addAttempts: 1 } }
  },
  "Santificarás las fiestas": {
    image: "santificar-fiestas.png",
    tag: "Descanso estratégico",
    short: "Pausar a tiempo te hace ver.",
    description: "Bendición: +45s (este acertijo). Voto: no pidas Pista 1 en los primeros 60s. Milagro: +45s ahora.",
    vow: { title: "Voto", text: "No puedes pedir Pista 1 en los primeros 60 segundos del acertijo." },
    power: { title: "Milagro", text: "Añade +45s al temporizador de este acertijo.", uses: { per: "turn", count: 1 }, effect: { addTimeSec: 45 } }
  },
  "No darás falso testimonio": {
    image: "no-falso-testimonio.png",
    tag: "Verdad con riesgo",
    short: "Si te expones, hay premio… o caída.",
    description: "Bendición: +30s (este acertijo). Voto: explica tu razonamiento. Milagro: +30s ahora.",
    vow: { title: "Voto", text: "Si dais una respuesta, debes explicar un razonamiento mínimo (1 frase). Si no, no cuenta como intento." },
    power: { title: "Milagro", text: "Añade +30s al temporizador de este acertijo.", uses: { per: "turn", count: 1 }, effect: { addTimeSec: 30 } }
  },
  "No codiciarás los bienes ajenos": {
    image: "no-codiciar-bienes.png",
    tag: "Autonomía y límite",
    short: "No vivas mirando el progreso del otro.",
    description: "Bendición: +60s (este acertijo). Voto: reformula ideas. Milagro: +60s ahora.",
    vow: { title: "Voto", text: "No puedes repetir literalmente una explicación ajena: debes reformularla con tus palabras." },
    power: { title: "Milagro", text: "Añade +60s al temporizador de este acertijo.", uses: { per: "turn", count: 1 }, effect: { addTimeSec: 60 } }
  },
  "No tendrás otros dioses frente a mí": {
    image: "no-otros-dioses.png",
    tag: "Enfoque y renuncia",
    short: "Ganas claridad renunciando a atajos.",
    description: "Bendición: +1 intento (este acertijo). Voto: no impongas respuestas. Milagro: +1 intento ahora.",
    vow: { title: "Voto", text: "No puedes imponer respuestas al grupo ('es esto y punto')." },
    power: { title: "Milagro", text: "Recuperas +1 intento en este acertijo.", uses: { per: "turn", count: 1 }, effect: { addAttempts: 1 } }
  },
  "No tomarás el nombre de Dios en vano": {
    image: "no-nombre-vano.png",
    tag: "Palabra con peso",
    short: "Si afirmas, sostén tu palabra.",
    description: "Bendición: +15s (este acertijo). Voto: 10s sin hablar tras pista. Milagro: +15s ahora.",
    vow: { title: "Voto", text: "Tras revelarse una pista, no puedes hablar durante 10 segundos." },
    power: { title: "Milagro", text: "Añade +15s al temporizador de este acertijo.", uses: { per: "turn", count: 1 }, effect: { addTimeSec: 15 } }
  },
  "No matarás": {
    image: "no-mataras.png",
    tag: "Cuidado y templanza",
    short: "No bloquees: construye.",
    description: "Bendición: tu próximo fallo solo resta intento (no tiempo). Voto: no culpes. Milagro: anula 1 penalización de tiempo por fallo.",
    vow: { title: "Voto", text: "No puedes culpar/atacar a un jugador ('por tu culpa') durante la sala." },
    power: { title: "Milagro", text: "Tu próximo fallo NO restará tiempo (solo consume intento).", uses: { per: "turn", count: 1 }, effect: { ignoreNextTimePenaltyOnce: true } }
  },
  "No cometerás actos impuros": {
    image: "no-actos-impuros.png",
    tag: "Juego limpio estricto",
    short: "Nada de atajos: claridad a cambio.",
    description: "Bendición: +30s (este acertijo). Voto: cero recursos externos. Milagro: +30s ahora.",
    vow: { title: "Voto", text: "No uses recursos externos (móvil/Google). Si lo haces, pierdes el derecho a activar Milagro en esta sala." },
    power: { title: "Milagro", text: "Añade +30s al temporizador de este acertijo.", uses: { per: "turn", count: 1 }, effect: { addTimeSec: 30 } }
  },
  "No consentirás pensamientos impuros": {
    image: "no-pensamientos-impuros.png",
    tag: "Perseverancia mental",
    short: "No huyas del bloqueo.",
    description: "Bendición: +1 intento (este acertijo). Voto: no pidas Pista 2 antes de fallar 1 vez. Milagro: +1 intento ahora.",
    vow: { title: "Voto", text: "No puedes pedir Pista 2 antes de haber fallado al menos 1 intento." },
    power: { title: "Milagro", text: "Recuperas +1 intento en este acertijo.", uses: { per: "turn", count: 1 }, effect: { addAttempts: 1 } }
  }
};

// =========================
// ARCHIVUM — Pecados (meta + tentación)
// Nota: La tentación NO desbloquea Pista 2. Se gasta el símbolo del turno para activar el poder.
// =========================
const SIN_META = {
  "Soberbia": {
    key: "Soberbia",
    img: "soberbia.png",
    short: "Orgullo desmedido.",
    effect: "Si insistes en una respuesta y fallas, recibes -15s extra (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: su próximo acertijo empieza con -30s.", uses: { per: "turn", count: 1 }, targetPenalty: { timeDelta: -30 } }
  },
  "Avaricia": {
    key: "Avaricia",
    img: "avaricia.png",
    short: "Apego exagerado.",
    effect: "Si pides demasiada ayuda, te cuesta: tras usar Pista 1, +15s al próximo fallo (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: su próximo acertijo empieza con -30s.", uses: { per: "turn", count: 1 }, targetPenalty: { timeDelta: -30 } }
  },
  "Lujuria": {
    key: "Lujuria",
    img: "lujuria.png",
    short: "Impulso de ir a lo fácil.",
    effect: "Si pides Pista 1, debes intentar responder antes de 60s o pierdes 1 intento (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: su próximo acertijo empieza con -1 intento.", uses: { per: "turn", count: 1 }, targetPenalty: { attemptsDelta: -1 } }
  },
  "Envidia": {
    key: "Envidia",
    img: "envidia.png",
    short: "Compararte constantemente.",
    effect: "No puedes apoyar una solución ajena sin añadir una idea nueva (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: no podrá activar su Milagro en su próximo acertijo.", uses: { per: "turn", count: 1 }, targetPenalty: { blockPower: true } }
  },
  "Gula": {
    key: "Gula",
    img: "gula.png",
    short: "No saber cuándo parar.",
    effect: "Si ya usaste una pista, cada fallo resta -15s extra (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: su próximo acertijo empieza con -60s.", uses: { per: "turn", count: 1 }, targetPenalty: { timeDelta: -60 } }
  },
  "Ira": {
    key: "Ira",
    img: "ira.png",
    short: "Reacción desmedida.",
    effect: "Tras un fallo, espera 20s antes de proponer otra respuesta (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: su próximo acertijo empieza con -30s y -1 intento.", uses: { per: "turn", count: 1 }, targetPenalty: { timeDelta: -30, attemptsDelta: -1 } }
  },
  "Pereza": {
    key: "Pereza",
    img: "pereza.png",
    short: "Dejarse llevar por la inercia.",
    effect: "Si pasan 90s sin aportar una idea, pierdes 1 intento automáticamente (personal).",
    temptation: { title: "Tentación", text: "Elige objetivo: no podrá activar su Tentación en su próximo acertijo.", uses: { per: "turn", count: 1 }, targetPenalty: { blockSinPower: true } }
  }
};
